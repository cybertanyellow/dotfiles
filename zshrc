...
# Path to your oh-my-zsh installation.
  export ZSH=/home/yellow/.oh-my-zsh
...
PERL5LIB="/home/yellow/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
PERL_LOCAL_LIB_ROOT="/home/yellow/perl5${PERL_LOCAL_LIB_ROOT:+:${PERL_LOCAL_LIB_ROOT}}"; export PERL_LOCAL_LIB_ROOT;
